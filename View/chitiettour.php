				...
				<div class="row">
					...
					<div class="info col-lg-4 col-md-12 col-sm-12 col-xs-12">
						<div class="frame-info pos-relative">
							<div class="sec1">
								<div class="viewed">
									<i class="fas fa-eye"></i>&nbsp;&nbsp;<span>746</span>&nbsp;&nbsp;
									<i class="far fa-thumbs-up" style="color: #777"></i>&nbsp;&nbsp;<span>126</span>&nbsp;&nbsp;
									<i class="far fa-comment" style="color: #777"></i>&nbsp;&nbsp;<span>5</span>
								</div>
							</div>
							<div class="sec2">
								...
								<div class="row">
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
										<div style="margin-bottom: 7px;" itemscope="" itemtype="http://schema.org/PriceSpecification">
											<span class="price" itemprop="price" content="4390000">4,390,000</span>&nbsp;<span class="unit" itemprop="priceCurrency" content="VND">đ</span>
										</div>
										<div>
											Số chỗ còn nhận:
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 text-right">
										<a href="/booking/inbound?tourId=0f9a5336-53fc-4b3b-aa7e-e407aea1918e&amp;LM=0" class="btn btn-book1 btn-md">Đặt ngay</a>
									</div>
								</div>
							</div>
							<div class="sec4">
								<div class="row">
									...
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
										<div style="margin-bottom: 7px;" itemscope="" itemtype="http://schema.org/PriceSpecification"><span class="price" itemprop="price" content="4190000">4,190,000</span>&nbsp;<span class="unit" itemprop="priceCurrency" content="VND">đ</span></div>
										<div>Số chỗ còn nhận: <span class="sit">5</span></div>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 text-right">
										<a href="#" class="btn btn-book2 btn-md">Đặt ngay</a>
									</div>
								</div>
							</div>
							<div class="sec5">
								...
								<div>
									...
									<div class="f-left btn-s2" data-toggle="modal" data-target="#divTuVan" style="cursor:pointer;"><img src="images/call2.png" alt="phone"></div>
									<div class="clear"></div>
								</div>
							</div>
